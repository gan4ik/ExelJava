...
public class formulaApp {
	...
	public static void main(String[] args) throws IOException {
		...
		Sheet sheet0 = wb.createSheet("Формулы");
		...
		Row row7 = sheet0.createRow(7);
		Cell cell7 = row7.createCell(0);
		cell7.setCellFormula("SUM(A4:A7)");
		
        FileOutputStream fos = new FileOutputStream("C:/Users/GannIV.GU.003/workspace/JavaExel/formula.xls");
